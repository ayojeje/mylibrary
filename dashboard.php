...
<body>
  <div class="wrapper">
      ...
      <div class="sidebar-wrapper scrollbar scrollbar-inner">
        <div class="sidebar-content">
          <ul class="nav nav-secondary">
            <li class="nav-item active" id="dashboardBtn">
            ...
            <li class="nav-item active" id="paymentBtn">
              <a class="collapsed" aria-expanded="false">
               ...
               <li class="nav-item active" id="categoryBtn">
              <a class="collapsed" aria-expanded="false">
                <i class="fas fa-address-book"></i>
             ...
             <li class="nav-item active" id="recentBtn">
              <a class="collapsed" aria-expanded="false">
                <i class="fas fa-address-book"></i>
                <p>recently uploaded books</p>
              </a>
            </li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="tables">
                <ul class="nav nav-collapse">
                  <li id="viewBooksBtn">
                    <a>
                      <span class="sub-item">Register/View Books</span>
                    </a>
                  </li>
    ...
    <div class="main-panel">
      ...
      <!-- <img src="annie-spratt-gl7joOaABlI-unsplash.jpg" width="100" height="100"> -->
      ...
      container">
        <div class="page-inner">
          <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
            <div>
              <h3 class="fw-bold mb-3">Administrative Dashboard</h3>
              <h6 class="op-7 mb-2">welcome to library management system where you can get any book of your choice!!!</h6>
            </div>
            <div class="ms-md-auto py-2 py-md-0">
              <!-- <a href="#" class="btn btn-label-info btn-round me-2">Manage</a>
              <a href="reg.php" class="btn btn-primary btn-round">Add Customer</a> -->
            </div>
          </div>
  ...
  <!-- <img src="book14.jpg" width="100%" height="400"> -->
                ...
                <div class="card card-stats card-round">
                  <div class="card-body">
                    <div class="row align-items-center">
                      ...
                      <div class="col col-stats ms-3 ms-sm-0">
                        <div class="numbers">
                          <p class="card-category">cartoonjp</p>
                ...
                <div class="card card-stats card-round">
                  <div class="card-body">
                    <div class="row align-items-center">
                      ...
                      <div class="col col-stats ms-3 ms-sm-0">
                        <div class="numbers">
                          <p class="card-category">The Egyptians Pyramid</p>
                          <h4 class="card-title">1303</h4>
                        </div>
                      </div>
                    </div>
                ...
                <div class="card card-stats card-round">
                  <div class="card-body">
                    <div class="row align-items-center">
                      ...
                      <div class="col col-stats ms-3 ms-sm-0">
                        <div class="numbers">
                          <p class="card-category">Egland</p>
                          <h4 class="card-title">$ 1,345</h4>
                        </div>
                      </div>
                    </div>
                ...
                <div class="card card-stats card-round">
                  <div class="card-body">
                    <div class="row align-items-center">
                      ...
                      <div class="col col-stats ms-3 ms-sm-0">
                        <div class="numbers">
                          <p class="card-category">tatanic</p>
                          <h4 class="card-title">576</h4>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="modal-content">
                        <div class="modal-header border-0">
                          <h5 class="modal-title">
                            ...
                            <span class="fw-light"> Books </span>
                          </h5>
                            ...
                            <div class="row">
                              <div class="col-sm-12">
                                <div class="form-group form-group-default">
                                  <label>TITLE</label>
                                  <input  name="title"  id="title" type="text" class="form-control" placeholder="name" />
                                </div>
                              </div>
                              <div class="col-md-6 pe-0">
                                <div class="form-group form-group-default">
                                  <label>AUTHOR</label>
                                  <input  name="author"  id="author" type="text" class="form-control" placeholder="genre" />
                                </div>
                              </div>
                              <div class="col-md-6">
                                <div class="form-group form-group-default">
                                  <label>GENRE</label>
                                  <input   name="genre"  id="genre" type="text" class="form-control" placeholder="author" />
                                </div>
                              </div>
                              <div class="col-md-6 pe-0">
                                <div class="form-group form-group-default">
                                  <label>CATEGORIES</label>
                                  <input  name="categories"  id="categories" type="text" class="form-control" placeholder="categories" />
                              ...
                              <div class="col-lg-6">
                                <div class="mb-3"><label for="image" class="form-label">Image</label>:</label>
                        ...
                        <div class="modal-footer border-0">
                          <button type="submit" id="addbooks" class="btn btn-primary">
                            Add
                          </button>
  ...
  <script>
    ...
    let recentView = document.getElementById("recentView") 
    let categoryView = document.getElementById("categoryView")
    let paymentView = document.getElementById("paymentView")
    let viewBooksView = document.getElementById("viewBooksView")

    initSecions();

    function initSecions(){
      dashboardView.style.display = 'block'
      paymentView.style.display = 'none'
      recentView.style.display = 'none'
      categoryView.style.display = 'none'
      viewBooksView.style.display = 'none'
    }
    ...
    viewBooksBtn.addEventListener("click", () => {
      ...
      viewBooksView.style.display = 'block'
      paymentView.style.display = 'none'
       recentView.style.display = 'none'
       categoryView.style.display = 'none'
